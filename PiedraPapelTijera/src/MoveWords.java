...
public class MoveWords{
    ...
    private static final String[] validMoves = {"LAGARTIJA", "SPOCK", "TIJERAS", "PAPEL", "PIEDRA"};
    ...
    public static int checkWinner(String first, String second){
	    ...
	    else if ((((first_i +1) % validMoves.length ) == second_i )||(((first_i +3) % validMoves.length ) == second_i )) {
            return GANA;
        }
        else{
            return PIERDE;
